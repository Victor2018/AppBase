package com.victor.lib.widget.util.emoji
...
object EmojiManager {
    ...
    init {
        load(WidgetModule.instance.mApplication, EMOT_DIR + "emoji.xml")
    ...
    private fun loadAssetBitmap(
        ...
        try {
            ...
            options.inScreenDensity = resources?.displayMetrics?.densityDpi ?: 0
            options.inTargetDensity = resources?.displayMetrics?.densityDpi ?: 0
