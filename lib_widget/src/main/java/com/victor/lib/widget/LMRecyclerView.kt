...
import com.victor.lib.widget.rvscroller.AdjustLinearSmoothScroller
import com.victor.lib.widget.rvscroller.CenterSmoothScroller
import com.victor.lib.widget.rvscroller.TopSmoothScroller
...
//            Log.e(TAG, "totalItemCount------->$totalItemCount")
            ...
            if (lastVisibleItem + 1 + headerCount >= totalItemCount && hasMore) {
                ...
                if (!isRvScrollBottom) {
//                    postEvent(Constant.Action.LV_SCROLL_BOTTOM)
                }
    ...
    fun scroll2LastPosition () {
        val contentCount = adapter?.itemCount ?: 0
